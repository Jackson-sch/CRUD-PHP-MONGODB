          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title mb-0">EDITAR MEDICAMENTO </h5>
                ...
                <form action="" method="POST">
                  <div class="row g-3">
                    <div class="col-md-2">
                      ...
                      <input type="text" class="form-control" name="Cod_Prod" value="<?php echo "$producto->Cod_Prod" ?>" required>
                    </div>
                    <div class="col-md-4">
                      <label for="Nom_Prod" class="form-label">Nombre Producto</label>
                      <input type="text" class="form-control" name="Nom_Prod" value="<?php echo "$producto->Nom_Prod" ?>" required>
                    </div>
                    <div class="col-md-4">
                      ...
                      <select class="form-select form-select-lg" name="Nom_Form_Farm">
                        <option value="<?php echo "$producto->Nom_Form_Farm" ?>"><?php echo "$producto->Nom_Form_Farm" ?></option>
                        <?php 
                        require_once "config.php";
                    ...
                    <div class="col-md-2">
                      ...
                      <select class="form-select" name="Nom_Form_Farm_Simplif">
                        <option value="<?php echo "$producto->Nom_Form_Farm_Simplif" ?>"><?php echo "$producto->Nom_Form_Farm_Simplif" ?></option>
                        <?php 
                          $collection = $database->FormaFarmac; //Selección de colección
                          $res = $collection->find();
                    ...
                    <div class="col-md-2">
                      ...
                      <input type="text" class="form-control" name="Concent" value="<?php echo "$producto->Concent" ?>" required>
                    </div>
                    <div class="col-md-2">
                      <label for="Presentac" class="form-label">Presentación</label>
                      <input type="text" class="form-control" name="Presentac" value="<?php echo "$producto->Presentac" ?>" required>
                    </div>
                    <div class="col-md-2">
                      <label for="Fec_Vcto_Reg_Sanitario" class="form-label">Fecha V.R Sanitario</label>
                      <input type="date" class="form-control" name="Fec_Vcto_Reg_Sanitario" value="<?php echo "$producto->Fec_Vcto_Reg_Sanitario" ?>" required>
                    </div>
                    <div class="col-md-2">
                      <label for="Num_RegSan" class="form-label">N° Registro Sanitario</label>
                      <input type="text" class="form-control" name="Num_RegSan" value="<?php echo "$producto->Num_RegSan" ?>" required>
                    </div>
                    <div class="col-md-4">
                      <label for="Nom_Titular" class="form-label">Laboratorio</label>
                      <div class="input-group">
                      <select class="form-select" name="Nom_Titular">
                        <option value="<?php echo "$producto->Nom_Titular" ?>"><?php echo "$producto->Nom_Titular" ?></option>
                        <?php 
